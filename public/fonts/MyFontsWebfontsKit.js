/*
 ...
 MyFonts Webfont Build ID 2911690, 2014-10-29T09:37:30-0400
 ...
 URL: http://www.myfonts.com/fonts/fontfont/ff-quadraat/ot-demi-bold/
 Copyright: 2011 Fred Smeijers published by FSI FontShop International GmbH

 Webfont: FF Quadraat Web Bold Italic by FontFont
 URL: http://www.myfonts.com/fonts/fontfont/ff-quadraat/ot-bold-italic/
 Copyright: 2009 Fred Smeijers published by FSI FontShop International GmbH

 Webfont: FF Quadraat Web Bold by FontFont
 URL: http://www.myfonts.com/fonts/fontfont/ff-quadraat/ot-bold/
 Copyright: 2009 Fred Smeijers published by FSI FontShop International GmbH

 Webfont: FF Quadraat Web DemiBold Italic by FontFont
 URL: http://www.myfonts.com/fonts/fontfont/ff-quadraat/ot-demi-bold-italic/
 Copyright: 2011 Fred Smeijers published by FSI FontShop International GmbH

 Webfont: FF Quadraat Web Italic by FontFont
 URL: http://www.myfonts.com/fonts/fontfont/ff-quadraat/ot-italic/
 Copyright: 2009 Fred Smeijers published by FSI FontShop International GmbH

 Webfont: FF Quadraat Web by FontFont
 URL: http://www.myfonts.com/fonts/fontfont/ff-quadraat/ot-regular/
 Copyright: 2009 Fred Smeijers published by FSI FontShop International GmbH


 License: http://www.myfonts.com/viewlicense?type=web&buildid=2911690
...
for(var fonts=[{fontFamily:"FFQuadraatWebDemiBold",url:wfpath+"2C6DCA_0"+suffix+"_0."+webfontType},{fontFamily:"FFQuadraat",fontWeight:"bold",fontStyle:"italic",url:wfpath+"2C6DCA_1"+suffix+"_0."+webfontType},{fontFamily:"FFQuadraat",fontWeight:"bold",fontStyle:"normal",url:wfpath+"2C6DCA_2"+suffix+"_0."+webfontType},{fontFamily:"FFQuadraatWebDemiBoldItalic",url:wfpath+"2C6DCA_3"+suffix+"_0."+webfontType},{fontFamily:"FFQuadraat",fontWeight:"normal",fontStyle:"italic",url:wfpath+"2C6DCA_4"+suffix+
"_0."+webfontType},{fontFamily:"FFQuadraatWeb",url:wfpath+"2C6DCA_5"+suffix+"_0."+webfontType}],len=fonts.length,css="",i=0;i<len;i++){var format="svg#wf"==webfontType?'format("svg")':"ttf"==webfontType?'format("truetype")':"eot"==webfontType?"":'format("'+webfontType+'")',css=css+("@font-face{font-family: "+fonts[i].fontFamily+";src:url("+fonts[i].url+")"+format+";");fonts[i].fontWeight&&(css+="font-weight: "+fonts[i].fontWeight+";");fonts[i].fontStyle&&(css+="font-style: "+fonts[i].fontStyle+";");
